...
/* External objects */
extern zeus_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
zeus_void printScannerError(zeus_char* fmt, ...);
zeus_void displayScanner(BufferReader* ptrBuffer);
zeus_long getScannerFilesize(zeus_char* fname);
